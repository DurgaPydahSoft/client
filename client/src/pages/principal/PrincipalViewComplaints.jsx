...
const PrincipalViewComplaints = () => {
  ...
  useEffect(() => {
    if (user) {
      console.log('Initial fetch of complaints for principal:', user);
      fetchComplaints();
    }
  ...
  const fetchComplaints = async () => {
    ...
    setError(null);
    try {
      console.log('Fetching complaints for principal...');
      let url = '/api/complaints/principal';
  ...
  const fetchTimeline = async (complaintId) => {
    ...
    try {
      const res = await api.get(`/api/complaints/principal/${complaintId}/timeline`);
      if (res.data.success) {
    ...
    <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-8 mt-12 sm:mt-0">
      ...
      <div className="mb-4 sm:mb-6 lg:mb-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-purple-900 to-purple-700 bg-clip-text text-transparent">
              Course Complaints
            </h1>
            <p className="text-gray-600 mt-1 sm:mt-2 text-xs sm:text-sm lg:text-base">
              Monitor complaints from students in your course
            </p>
          </div>
        </div>
      </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-2 sm:gap-3 lg:gap-4">
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 lg:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg transition-colors"
                  >
      ...
      <AnimatePresence>
        {selected && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className="bg-gradient-to-r from-purple-600 to-purple-800 px-3 sm:px-4 lg:px-6 py-2 sm:py-3 lg:py-4 rounded-t-xl">
...
export default PrincipalViewComplaints; 
        ...
        >
          ...
          <div className="bg-gray-50 px-4 sm:px-8 py-3 sm:py-4 border-t border-gray-200">
            <div className="flex items-center text-xs sm:text-sm text-gray-600">
              ...
              <span className="leading-relaxed">Your complaints will be addressed within 24-48 hours</span>
            </div>
          </div>
        </motion.div>

        {/* AI Processing Overlay - Mobile optimized */}
        {aiProcessing && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-xl p-6 sm:p-8 text-center max-w-sm sm:max-w-md mx-auto w-full">
